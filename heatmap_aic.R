...
p_values_uc <- matrix(c(
  ...
  0.0198, 0.5275, 0.3928, NA, 0.0000, 0.3928,  # ETH-USD
  0.0865, 0.5887, 0.9530, 0.0018, 0.9530, 0.9530  # BNB-USD
), nrow=3, byrow=TRUE)

p_values_cc <- matrix(c(
  0.0069, 0.3744, 0.3744, 0.0000, NA, 0.2669,  # BTC-USD
  0.0519, 0.4109, 0.3744, NA, 0.0000, 0.3744,  # ETH-USD
  0.1580, 0.7499, 0.8343, 0.0069, 0.8343, 0.8343  # BNB-USD
), nrow=3, byrow=TRUE)
